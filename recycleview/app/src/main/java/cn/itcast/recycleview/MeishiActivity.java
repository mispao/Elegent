...
public class MeishiActivity extends AppCompatActivity {
    ...
    private  String[] introduces = {"料很足，两个人分刚好",
            "量很足，里面的东西很丰盛，完美",
            "牛肉汉堡份量刚刚好，肉馅很新鲜",
